...
main = Tk()
main.title("Machine Learning-Based Car Model Prediction through Vehicle Pattern Recognition")
...
def linearKNN():
    ...
    cls = LogisticRegression(C=0.01, penalty='l1',solver='liblinear') 
...
font = ('times', 15, 'bold')
title = Label(main, text='Machine Learning-Based Car Model Prediction through Vehicle Pattern Recognition')
...
knnButton = Button(main, text="Linear Regression & KNN", command=linearKNN)
knnButton.place(x=20,y=150)
knnButton.config(font=ff)

cnnButton = Button(main, text="SVM & CNN", command=SVMCNN)
cnnButton.place(x=20,y=200)
cnnButton.config(font=ff)

svmButton = Button(main, text="KNN & SVM", command=KNNSVM)
svmButton.place(x=20,y=250)
svmButton.config(font=ff)

kcnnButton = Button(main, text="KNN & CNN", command=KNNCNN)
